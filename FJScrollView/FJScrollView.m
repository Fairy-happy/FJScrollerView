...
@interface FJScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (void)initialization
{
    _pageControlAliment = FJScrollViewPageContolAlimentCenter;
    ...
    _pageControlStyle = FJScrollViewPageContolStyleAnimated;
...
{
    FJScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[FJCollectionViewCell class] forCellWithReuseIdentifier:ID];
...
- (void)setPageControlStyle:(FJScrollViewPageContolStyle)pageControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case FJScrollViewPageContolStyleAnimated:
        {
        ...
        case FJScrollViewPageContolStyleClassic:
        {
...
- (void)layoutSubviews
{
    ...
    if (self.pageControlAliment == FJScrollViewPageContolAlimentRight) {
...
{
    FJCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
